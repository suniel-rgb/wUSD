...
const features = [
    'wUSD cannot be bought on exchanges',
    'wUSD is minted only through real activity',
    'wUSD is backed by verifiable protocol revenue',
    'wUSD introduces downside protection for traders',
];
</script>
