...
const orbitItems = {
    full: [
        ...
        { iconType: 'shield', label: 'Treasury', color: 'bg-blue-500', delay: '-12s' },
    ...
    treasury: [
        ...
        { iconType: 'arrow-right-left', label: 'Fees', color: 'bg-blue-500', delay: '-4s' },
        { iconType: 'shield', label: 'Solvency', color: 'bg-blue-500', delay: '-8s' },
        { iconType: 'layers', label: 'Revenue', color: 'bg-blue-500', delay: '-12s' },
    ],
    earning: [
        { iconType: 'users', label: 'Signup', color: 'bg-blue-500', delay: '0s' },
